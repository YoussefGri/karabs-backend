...
class getSecurity_HelperService extends App_KernelProdContainer
{
    ...
    public static function do($container, $lazyLoad = true)
    {
        return $container->privates['security.helper'] = new \Symfony\Bundle\SecurityBundle\Security(new \Symfony\Component\DependencyInjection\Argument\ServiceLocator($container->getService ??= $container->getService(...), [
            ...
            'App\\Security\\AdminAuthenticator' => ['privates', 'App\\Security\\AdminAuthenticator', 'getAdminAuthenticatorService', true],
        ], [
            'App\\Security\\AdminAuthenticator' => '?',
        ]), 'main' => new \Symfony\Component\DependencyInjection\Argument\ServiceLocator($container->getService ??= $container->getService(...), [
            'App\\Security\\OAuthAuthenticator' => ['privates', 'App\\Security\\OAuthAuthenticator', 'getOAuthAuthenticatorService', true],
        ], [
