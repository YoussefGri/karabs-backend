...
class getSecurity_Logout_Listener_Default_AdminService extends App_KernelProdContainer
{
    ...
    public static function do($container, $lazyLoad = true)
    {
        ...
        return $container->privates['security.logout.listener.default.admin'] = new \Symfony\Component\Security\Http\EventListener\DefaultLogoutListener($a, 'admin_login');
    }
}
