...
class __TwigTemplate_fb848a6730993d068a52b85c39ee5a8d extends Template
{
    ...
    public function block_content_title(array $context, array $blocks = []): iterable
    {
        ...
        yield "Bienvenue dans l'administration du Krabs";
        ...
        <div class=\"col-md-4\">
            <div class=\"card\">
                ...
                <div class=\"card-body\">
                    ...
                    <p class=\"card-text\">Gérez les comptes utilisateurs, les rôles et les informations personnelles.</p>
                    <a href=\"";
        // line 13
        yield $this->env->getRuntime('Twig\Runtime\EscaperRuntime')->escape(CoreExtension::getAttribute($this->env, $this->source, $this->extensions['EasyCorp\Bundle\EasyAdminBundle\Twig\EasyAdminTwigExtension']->getAdminUrlGenerator(), "setController", ["App\\Controller\\Admin\\UserCrudController"], "method", false, false, false, 13), "html", null, true);
        yield "\" class=\"btn btn-primary\">Voir les utilisateurs</a>
                </div>
            </div>
        </div>
        
        <!-- Ajoutez d'autres cartes pour vos autres entités -->
    </div>
";
...
{% block content_title 'Bienvenue dans l\\'administration du Krabs' %}
        ...
        <div class=\"col-md-4\">
            <div class=\"card\">
                ...
                <div class=\"card-body\">
                    <h5 class=\"card-title\">Gestion des utilisateurs</h5>
                    <p class=\"card-text\">Gérez les comptes utilisateurs, les rôles et les informations personnelles.</p>
                    <a href=\"{{ ea_url().setController('App\\\\\\Controller\\\\\\Admin\\\\\\UserCrudController') }}\" class=\"btn btn-primary\">Voir les utilisateurs</a>
                </div>
            </div>
        </div>
...
{% endblock %}", "admin/dashboard.html.twig", "C:\\Users\\razay\\Downloads\\fadel\\fadel\\krabs-backend-v2\\templates\\admin\\dashboard.html.twig");
    }
}
