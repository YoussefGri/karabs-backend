 ...
 */
final class Version20250403211124 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE enseigne_user (enseigne_id INT NOT NULL, user_id INT NOT NULL, INDEX IDX_320F0D5C6C2A0A71 (enseigne_id), INDEX IDX_320F0D5CA76ED395 (user_id), PRIMARY KEY(enseigne_id, user_id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        ...
        $this->addSql('CREATE TABLE notation (id INT AUTO_INCREMENT NOT NULL, user_id INT NOT NULL, enseigne_id INT NOT NULL, note DOUBLE PRECISION NOT NULL, commentaire LONGTEXT DEFAULT NULL, date_creation DATETIME NOT NULL, INDEX IDX_268BC95A76ED395 (user_id), INDEX IDX_268BC956C2A0A71 (enseigne_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        ...
        $this->addSql('ALTER TABLE enseigne_user ADD CONSTRAINT FK_320F0D5C6C2A0A71 FOREIGN KEY (enseigne_id) REFERENCES enseigne (id) ON DELETE CASCADE');
        $this->addSql('ALTER TABLE enseigne_user ADD CONSTRAINT FK_320F0D5CA76ED395 FOREIGN KEY (user_id) REFERENCES `user` (id) ON DELETE CASCADE');
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE enseigne_user DROP FOREIGN KEY FK_320F0D5C6C2A0A71');
        $this->addSql('ALTER TABLE enseigne_user DROP FOREIGN KEY FK_320F0D5CA76ED395');
        ...
        $this->addSql('DROP TABLE enseigne_user');
