 ...
 */
final class Version20250525161530 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE categorie (id INT AUTO_INCREMENT NOT NULL, nom VARCHAR(255) NOT NULL, image VARCHAR(255) DEFAULT NULL, couleur VARCHAR(50) DEFAULT NULL, PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        $this->addSql('CREATE TABLE enseigne (id INT AUTO_INCREMENT NOT NULL, nom VARCHAR(255) NOT NULL, numero_telephone VARCHAR(255) NOT NULL, adresse VARCHAR(255) NOT NULL, latitude DOUBLE PRECISION DEFAULT NULL, longitude DOUBLE PRECISION DEFAULT NULL, photo VARCHAR(255) DEFAULT NULL, description LONGTEXT NOT NULL, points_cle JSON DEFAULT NULL, website VARCHAR(255) DEFAULT NULL, note_prix DOUBLE PRECISION DEFAULT NULL, note_qualite DOUBLE PRECISION DEFAULT NULL, note_ambiance DOUBLE PRECISION DEFAULT NULL, slogan VARCHAR(70) DEFAULT NULL, PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        ...
        $this->addSql('CREATE TABLE notation (id INT AUTO_INCREMENT NOT NULL, user_id INT NOT NULL, enseigne_id INT NOT NULL, note_prix DOUBLE PRECISION DEFAULT NULL, note_qualite DOUBLE PRECISION DEFAULT NULL, note_ambiance DOUBLE PRECISION DEFAULT NULL, commentaire LONGTEXT DEFAULT NULL, date_creation DATETIME NOT NULL, INDEX IDX_268BC95A76ED395 (user_id), INDEX IDX_268BC956C2A0A71 (enseigne_id), UNIQUE INDEX unique_user_enseigne (user_id, enseigne_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        $this->addSql('CREATE TABLE `user` (id INT AUTO_INCREMENT NOT NULL, email VARCHAR(180) NOT NULL, roles JSON NOT NULL, password VARCHAR(255) DEFAULT NULL, name VARCHAR(255) DEFAULT NULL, avatar VARCHAR(255) DEFAULT NULL, oauth_id VARCHAR(255) DEFAULT NULL, oauth_provider VARCHAR(50) DEFAULT NULL, nom VARCHAR(255) DEFAULT NULL, prenom VARCHAR(255) DEFAULT NULL, ville VARCHAR(255) DEFAULT NULL, code_postal VARCHAR(5) DEFAULT NULL, reset_token VARCHAR(255) DEFAULT NULL, reset_requested_at DATETIME DEFAULT NULL, UNIQUE INDEX UNIQ_8D93D649E7927C74 (email), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
